...
const variants = {
  base: 'relative rounded-md p-4 w-96 max-w-[250px] flex justify-center items-center flex-col cursor-pointer border border-dashed border-gray-400 dark:border-gray-300 transition-colors duration-200 ease-in-out',
  active: 'border-2',
  disabled:
          ...
          {value?.map(({ file, progress }, i) => (
            ...
            >
              <div className="flex items-center gap-2 text-gray-500 dark:text-white">
                ...
                <div className="flex flex-row items-center w-12 justify-end text-xs">
                {
                    progress === 'COMPLETE' && <Button onClick={() => removeFile()}><Trash2Icon className="shrink-0" /></Button>
                }
                  {progress === 'PENDING' ? (
                    <button
