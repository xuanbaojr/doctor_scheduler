...
def StackedHourglassNetwork(
    ...
    output_1, output_2, output_3, output_final = ys
    return tf.keras.Model(inputs, outputs = [output_1, output_2, output_3, output_final], name='stacked_hourglass')
...
model = StackedHourglassNetwork(input_shape = (256, 256, 3))
