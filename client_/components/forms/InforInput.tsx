...
import GenderBox from '../card/Gender'
import { Gender } from '@/constant/enum'
import SliderAge from '../card/SliderAge'
import { GestureHandlerRootView, ScrollView } from 'react-native-gesture-handler'
import FieldInput from '../card/FieldInput'
import BottomUnder from '../card/BottomUnder'
import BottomSubmit from '../card/BottomSubmit'
import PublicImage from '../card/PublicImage'
import SelectMajor from '../card/SelectMajor'
import { noteTitle } from '@/constant/screen/post'
import {  KeyboardAvoidingView, Text,  View } from 'react-native'
import { MyContext, MyFunctionType } from '../context/UpLoadContext'
import { OptionUpLoad } from './UpAndLoadImage'
